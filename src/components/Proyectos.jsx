            ...
            <div className="grid gap-2 md:grid-cols-2">
                ...
                <div className="flex flex-col gap-2 py-5 md:py-0 px-0 md:px-5">
                    ...
                    <div className='flex flex-wrap gap-3'>
                        ...
                        <p className='inline-flex text-sm bg-gray-800 dark:bg-blue-600 text-gray-300 dark:text-white rounded-full px-3 py-1 gap-2'>
                        ...
                        <p style={{ backgroundColor: '#6015A1' }} className='inline-flex px-3 py-1  rounded-full gap-2'>
