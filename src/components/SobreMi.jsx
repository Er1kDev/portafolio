...
export default function SobreMi() {
    ...
    return (
        <section id="sobre-mi" className="text-gray-800 dark:text-white section undefined scroll-m-20 w-full mx-auto container lg:max-w-4xl md:max-w-2xl">
            <div className="flex items-center mb-6 text-3xl font-semibold gap-x-3 undefined">
            ...
            <article className="flex flex-col md:flex-row items-center justify-center gap-8">
                ...
                <p className="order-2 md:order-1 text-gray-600 dark:text-gray-400">
